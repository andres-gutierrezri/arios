...
permisos = [Permiso('index', None),
            ...
            Permiso('consecutivo-viaticoscomisiones-index', ['GestionDocumental.view_viaticoscomisiones']),
            Permiso('consecutivo-viaticoscomisiones-crear', ['GestionDocumental.add_viaticoscomisiones']),
            Permiso('consecutivo-viaticoscomisiones-editar', ['GestionDocumental.change_viaticoscomisiones']),
            Permiso('consecutivo-viaticoscomisiones-eliminar', ['GestionDocumental.delete_viaticoscomisiones']),
            ]
