...
class ConsecutivoOrdenesTrabajoCrearView(AbstractEvaLoggedView):
    ...
    def post(self, request, id):
        ...
        try:
            ...
            rollback()
            LOGGER.exception('Falló la generación del consecutivo de órdenes de trabajo.')
    ...
    def post(self, request, id):
        ...
        if consecutivo_db.comparar(consecutivo, excluir=['usuario_crea', 'fecha_crea', 'fecha_modificacion',
            ...
            try:
                ...
                rollback()
                LOGGER.exception('Falló la edición del consecutivo de órdenes de trabajo.')
                RespuestaJson.error('Falló la edición del consecutivo de órdenes de trabajo.')
...
class ConsecutivoOrdenesTrabajoEliminarView(AbstractEvaLoggedView):
    def post(self, request, id):
        ...
        try:
            ...
            rollback()
            LOGGER.exception('Error anulando el consecutivo de órdenes de trabajo')
