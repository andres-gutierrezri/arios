...
class Contrato(models.Model, ModelDjangoExtensiones):
    ...
    def from_dictionary(datos: dict) -> 'Contrato':
        ...
        contrato.cliente_id = int(datos.get('cliente_id', ''))
        contrato.anho = int(datos.get('rango_anho', ''))
        ...
        contrato.valor = int(datos.get('valor', 0))
        contrato.periodicidad_informes = int(datos.get('periodicidad_informes', 0))
        contrato.tiempo = int(datos.get('tiempo', ''))
        contrato.tipo_contrato_id = int(datos.get('tipo_contrato_id', ''))
        contrato.empresa_id = int(datos.get('empresa_id', ''))
