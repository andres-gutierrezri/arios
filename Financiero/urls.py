...
urlpatterns = [
    ...
    path('flujo-caja/contratos/<int:id>/detalle/<int:tipo>/anio/<int:anio>/mes/<int:mes>',
         flujo_caja_contratos.FlujoCajaContratosDetalleView.as_view(), name='flujo-caja-contratos-detalle'),
    ...
    path('flujo-caja/procesos/<int:id>/detalle/<int:tipo>/anio/<int:anio>/mes/<int:mes>',
         flujo_caja_procesos.FlujoCajaProcesosDetalleView.as_view(), name='flujo-caja-procesos-detalle'),
    ...
    path('flujo-caja/consolidado/descargar', flujo_caja_consolidado.FlujoCajaConsolidadoView.as_view(),
         name='flujo-caja-consolidado-descarga'),
    ...
    path('flujo-caja/<int:id_movimiento>/aplicar', flujo_caja_general.FlujoCajaMovimientoAplicarView.as_view(),
         name='flujo-caja-movimiento-aplicar'),
]
