from decimal import Decimal, ROUND_DOWN, ROUND_05UP, localcontext
...
class TestFacturaEncabezado(TestCase):
    ...
    factura_encabezado_2 = FacturaEncabezado(valor_impuesto=1730964.67, subtotal=9110340.36)
    ...
    def test_total_administracion(self):
        self.assertEqual(self.factura_encabezado_1.total_administracion, Decimal('4996648.36'))
        self.assertEqual(self.factura_encabezado_2.total_administracion, Decimal('0.00'))
        self.assertEqual(self.factura_encabezado_3.total_administracion, Decimal('0.00'))

    def test_total_imprevistos(self):
        self.assertEqual(self.factura_encabezado_1.total_imprevistos, Decimal('681361.14'))
        self.assertEqual(self.factura_encabezado_2.total_imprevistos, Decimal('0.00'))
        self.assertEqual(self.factura_encabezado_3.total_imprevistos, Decimal('0.00'))

    def test_total_utilidad(self):
        self.assertEqual(self.factura_encabezado_1.total_utilidad, Decimal('2271203.80'))
        self.assertEqual(self.factura_encabezado_2.total_utilidad, Decimal('0.00'))
        self.assertEqual(self.factura_encabezado_3.total_utilidad, Decimal('0.00'))
    ...
    def test_total_factura(self):
        self.assertEqual(self.factura_encabezado_1.total_factura, Decimal('30661251.30'))
        self.assertEqual(self.factura_encabezado_2.total_factura, Decimal('10841305.03'))
        self.assertEqual(self.factura_encabezado_3.total_factura, Decimal('61997.76'))
