...
permisos = [Permiso('index', None),
            Permiso('grupo-actividades-index', ['GestionActividades.view_grupoactividad']),
            Permiso('grupo-actividades-crear', ['GestionActividades.add_grupoactividad']),
            Permiso('grupo-actividades-editar', ['GestionActividades.change_grupoactividad']),
            Permiso('grupo-actividades-eliminar', ['GestionActividades.delete_grupoactividad']),
